...
% Add personal page https://github.io/ctroupin/ +  add new logo fontawesome
...
Julia: data reading/writing (CSV, netCD), numerical analysis, \newline
...
Web: HTML, CSS, JavaScript, Jekyll, D3, Angular, Wordpress\newline
...
\cvitem{Image processing}{GIMP, Inkskape, Darktable, ImageJ, Matlab, Python, ffmpeg, hugin, ImageMagick, gcolor2}
...
\cvitem{Other tools}{NX~Client, version control system (SVN, git), VPN, LaTeX (BibTex, Beamer, TikZ), Dokuwiki, Mediawiki, freemind, Asana}
