...
\circled{\includegraphics[height=1.6ex]{gitlab_logo.png}} & \url{https://gitlab.com/ctroupin} 	& \faGithubSquare	& \url{https://github.com/ctroupin/} \\
...
\chronoperiode[textstyle=\raggedleft\colorbox{CVgrey},color=CVmain, startdate=false, bottomdepth=0pt, topheight=8pt, textdepth=-25pt,dateselevation=16pt,stopdate=false,datesseparation=/]{9/1/2017}{31/12/2020}{\includegraphics[width=\logowidth]{logo_uliege}~\includegraphics[width=.7\logowidth]{logo_gher}}
