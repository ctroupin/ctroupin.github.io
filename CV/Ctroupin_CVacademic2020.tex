...
\item[Data analytics] \skillbox{Quality control} \skillbox{Singular events} \skillbox{Filtering} \skillbox{Data mining} \skillbox{Statistics}  \skillbox{Predictive modelling}

\item[Engineering] \skillbox{Fluid mechanics} \skillbox{Aerodynamics} \skillbox{Finite-Element Method} \skillbox{Atmospheric Physics} \skillbox{Numerical simulations} \skillbox{Numerical analysis} \skillbox{Signal processing} \skillbox{Optimization} \skillbox{High-performance computing}

\item[Physical Oceanography] \skillbox{Spatial interpolation} \skillbox{Time-Series Analysis} \skillbox{Principal Component Analysis} \skillbox{Numerical Modelling} \skillbox{Data Processing} \skillbox{Database Management} \skillbox{Satellite Image Processing}
