...
\includegraphics[width=.35cm]{logo_orcid.png} & \url{http://orcid.org/0000-0002-0265-1021} & \faTwitterSquare &  \url{https://twitter.com/CharlesTroupin} \\
\end{tabular*}
...
\begin{tabular}{p{.125\textwidth}| p{.835\textwidth}}
...
\newline Other: Julia, Fortran 77, 90, Tcl/Tk, JavaScript (Leaflet, Highcharts), MySQL\\
%\cvitemf{Operating systems}{Preference with Linux (Mint, Ubuntu) \sepa Experience with Mac~OS~X Lion, Microsoft Windows}
...
Other tools & Version control (SVN, git) \sepa LaTeX (documents, posters, presentations, leaflet) \sepa Wiki (Dokuwiki, Mediawiki) \sepa Ocean-related software: Ocean Data View, DIVA (spatial interpolation), DINEOF (spatio-temporal interpolation of satellite images) \sepa Image processing: Darktable, GIMP, ImageMagick, Inkscape, ffmpeg\\
...
%{\Large \bf Projects \& publications} % destacados


%\vspace*{-.75cm}

\bibliography{Troupin_publis_shortlist.bib}
