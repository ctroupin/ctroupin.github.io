...
Prior to that, I've been organizing [trekking and running activities in Mallorca]({{ site.url }}/leaflet/MallorcaActivities) with friend and colleagues, especially in the *Tramuntana*.
