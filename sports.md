...
<img src="{{ site.url }}/figures/GC_activity.png" class="img-responsive" alt="Running in Gran Canaria">

After Gran Canaria I ran in the other Canary Islands and now I try to run everywhere I go, either for work or on holiday. Not only can I discover new places and tracks, but also I made several friends that share the same passion for the sport. Here is where we've been running recently around the [Sart Tilman]({{ site.url }}/leaflet/Running-SartTilman.html) (Liège).

Prior to that, I've been organizing trekking and running activities in [Mallorca]({{ site.url }}/leaflet/MallorcaActivities.html) with friend and colleagues, especially in the *Tramuntana*.
